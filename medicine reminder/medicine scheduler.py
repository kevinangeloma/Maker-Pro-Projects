...
import DS3231 import SDL_DS3231 as DS3231
	...
	if checked_schedule == False:
        ...
        if off_was_printed == False:
            if cur_time_mins >= turn_off_mins:
                ...
                off_was_printed = True
                was_printed = 0 # to prevent re-checking during the reminder period that would move the reminder window and we do not want that
                if weekday == 0:
