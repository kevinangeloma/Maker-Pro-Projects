...
from DS3231 import SDL_DS3231 as DS3231 #calling for special functions which helps us interface RTC module
from board import *
...
while True: 
    ...
    while True:
        ...
        if (alarm==1):
            ...
            if ((h==rtc._read_hours())):
                if ((m==rtc._read_minutes())):
        ...
        send_a_string ("Time:%02d:%02d:%02d" % (rtc._read_hours(),rtc._read_minutes(),rtc._read_seconds()));
